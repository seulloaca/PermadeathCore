...
public class EndTask extends BukkitRunnable {
    ...
    public EndTask(Main plugin, EnderDragon enderDragon) {
        ...
        enderDragon.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(instance.getConfig().getInt("Toggles.End.PermadeathDemon.Health"));
        enderDragon.setHealth(instance.getConfig().getInt("Toggles.End.PermadeathDemon.Health"));
