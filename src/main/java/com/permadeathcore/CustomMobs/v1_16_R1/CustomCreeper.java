...
public class CustomCreeper extends EntityCreeper {
    ...
    private boolean o(double d0, double d1, double d2) {
        net.minecraft.server.v1_16_R1.BlockPosition.MutableBlockPosition blockposition_mutableblockposition = new net.minecraft.server.v1_16_R1.BlockPosition.MutableBlockPosition(d0, d1, d2);
        ...
        while(blockposition_mutableblockposition.getY() > 0 && !this.world.getType(blockposition_mutableblockposition).getMaterial().isSolid()) {
            blockposition_mutableblockposition.c(net.minecraft.server.v1_16_R1.EnumDirection.DOWN);
        }

        net.minecraft.server.v1_16_R1.IBlockData iblockdata = this.world.getType(blockposition_mutableblockposition);
