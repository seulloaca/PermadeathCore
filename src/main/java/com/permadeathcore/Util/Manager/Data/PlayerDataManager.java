...
public class PlayerDataManager {
    ...
    public ItemStack craftHead() {
        ...
        meta.setLore(Arrays.asList(instance.format("&c&lHA SIDO PERMABANEADO"), instance.format(" "), instance.format("&7Fecha del Baneo: &c" + banDay), instance.format("&7Hora del Baneo: &c" + banTime), instance.format("&7Causa del Baneo: " + banCause)));
        s.setItemMeta(meta);
    ...
    public ItemStack craftHead(ItemStack s) {
        ...
        meta.setDisplayName(instance.format("&c&l" + name));
        meta.setLore(Arrays.asList(instance.format("&c&lHA SIDO PERMABANEADO"), instance.format(" "), instance.format("&7Fecha del Baneo: &c" + banDay), instance.format("&7Hora del Baneo: &c" + banTime), instance.format("&7Causa de Muerte: " + banCause)));
        s.setItemMeta(meta);
