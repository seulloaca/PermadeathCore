...
public class NMSAccesor_1_16_R1 implements NMSAccesor {
    ...
    public EntityInsentient getEntityInsentiment(Entity en) {
        ...
        net.minecraft.server.v1_16_R1.Entity entity = ((CraftEntity) en).getHandle();
    ...
    public void injectHostilePathfinders(Entity entity) {
        ...
        if (nms instanceof EntityCreature) {
            ...
            net.minecraft.server.v1_16_R1.EntityCreature insentient = (net.minecraft.server.v1_16_R1.EntityCreature) ((org.bukkit.craftbukkit.v1_16_R1.entity.CraftEntity) entity).getHandle();
        ...
        if (nms instanceof EntityInsentient) {
            ...
            net.minecraft.server.v1_16_R1.EntityInsentient insentient = (net.minecraft.server.v1_16_R1.EntityInsentient) ((org.bukkit.craftbukkit.v1_16_R1.entity.CraftEntity) entity).getHandle();
    ...
    public void addNMSTag(Entity entity) {
        ...
        net.minecraft.server.v1_16_R1.Entity en = ((CraftEntity)entity).getHandle();
    ...
    public AttributeBase bukkitToNMSAttribute(Attribute attribute) {
        ...
        if (attribute == Attribute.GENERIC_ATTACK_DAMAGE) {
            ...
            ia = net.minecraft.server.v1_16_R1.GenericAttributes.ATTACK_DAMAGE;
        }

        if (attribute == Attribute.GENERIC_ARMOR_TOUGHNESS) {

            ia = net.minecraft.server.v1_16_R1.GenericAttributes.ARMOR_TOUGHNESS;
        }

        if (attribute == Attribute.GENERIC_ARMOR) {

            ia = net.minecraft.server.v1_16_R1.GenericAttributes.ARMOR;
        }

        if (attribute == Attribute.GENERIC_MAX_HEALTH) {

            ia = net.minecraft.server.v1_16_R1.GenericAttributes.MAX_HEALTH;
        }

        if (attribute == Attribute.GENERIC_KNOCKBACK_RESISTANCE) {

            ia = net.minecraft.server.v1_16_R1.GenericAttributes.KNOCKBACK_RESISTANCE;
        }

        if (attribute == Attribute.GENERIC_ATTACK_SPEED) {

            ia = net.minecraft.server.v1_16_R1.GenericAttributes.ATTACK_SPEED;
        }
    ...
    public Class getNMSEntityClass(String name) {
        ...
        try {
            return Class.forName("net.minecraft.server.v1_16_R1.Entity" + name);
    ...
    public void drown(org.bukkit.entity.Player p, double ammount) {
        ...
        net.minecraft.server.v1_16_R1.Entity en = ((CraftEntity)p).getHandle();
