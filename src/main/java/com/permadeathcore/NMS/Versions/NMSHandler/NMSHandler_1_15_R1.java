...
public class NMSHandler_1_15_R1 implements NMSHandler {
    ...
    public org.bukkit.entity.Entity spawnNMSCustomEntity(String name, EntityType type, Location location, CreatureSpawnEvent.SpawnReason reason) {
        ...
        try {
            ...
            Class c = Class.forName("com.permadeathcore.CustomMobs.v1_15_R1." + name);
    ...
    @Override
    public org.bukkit.entity.Entity spawnCustomCreeper(Location location, CreatureSpawnEvent.SpawnReason reason, boolean isEnder) {


        World nmsW = ((CraftWorld) location.getWorld()).getHandle();
        CustomCreeper nmsEntity = new CustomCreeper(EntityTypes.CREEPER, nmsW, isEnder);
    ...
    public void addMushrooms() {
        ...
        Class c = BiomeBase.class;

        try {

            BiomeMushrooms m = BiomeMushrooms.class.newInstance();
