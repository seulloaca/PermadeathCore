...
public class NMSHandler_1_16_R1 implements NMSHandler {
    ...
    public EntityTypes convertBukkitToNMS(EntityType type) {
        ...
        if (type == EntityType.valueOf("BEE")) {
    ...
    public org.bukkit.entity.Entity spawnNMSEntity(String name, EntityType type, Location location, CreatureSpawnEvent.SpawnReason reason) {
        ...
        net.minecraft.server.v1_16_R1.World nmsW = ((org.bukkit.craftbukkit.v1_16_R1.CraftWorld) location.getWorld()).getHandle();
            ...
            if (name.toLowerCase().contains("bat") || name.toLowerCase().contains("cod") || name.toLowerCase().contains("salmon") || name.toLowerCase().contains("squid") || name.toLowerCase().contains("pufferfish") || name.toLowerCase().contains("tropicalfish")) {
                ...
                if (reason == CreatureSpawnEvent.SpawnReason.SPAWNER_EGG) {
                    ...
                    if (new Random().nextInt(499) <= 10) {
                        ...
                        nmsEntity = (net.minecraft.server.v1_16_R1.Entity) c.getConstructor(getNMSClass("EntityTypes"), getNMSClass("World")).newInstance(convertBukkitToNMS(type), nmsW);
                    }
                } else {
    ...
    public Entity spawnNMSWither(Location location) {
        ...
        net.minecraft.server.v1_16_R1.EntityWither wither = net.minecraft.server.v1_16_R1.EntityTypes.WITHER.spawnCreature(nmsW, compound, null, null,
                new net.minecraft.server.v1_16_R1.BlockPosition(location.getBlockX(), location.getBlockY(), location.getBlockZ()),
                net.minecraft.server.v1_16_R1.EnumMobSpawn.EVENT, true, false);
    ...
    public org.bukkit.entity.Entity spawnHostileMob(EntityType type, Location location, CreatureSpawnEvent.SpawnReason reason) {
        ...
        try {
            ...
            if (name.toLowerCase().contains("cod") && com.permadeathcore.Main.getInstance().getDays() >= 50) {
                return null;
            }
            ...
            if (name.toLowerCase().contains("villager") || name.toLowerCase().contains("wanderingtrader")) {
                ...
                if (name.toLowerCase().contains("bat") || name.toLowerCase().contains("cod") || name.toLowerCase().contains("salmon") || name.toLowerCase().contains("squid") || name.toLowerCase().contains("pufferfish") || name.toLowerCase().contains("tropicalfish")) {
                    ...
                    if (new Random().nextInt(499) <= 10) {
                        ...
                        nms = (net.minecraft.server.v1_16_R1.Entity) c.getConstructor(Location.class, com.permadeathcore.Main.getInstance().getNmsHandler().getNMSClass("EntityTypes")).newInstance(location, com.permadeathcore.Main.getInstance().getNmsHandler().convertBukkitToNMS(type));
                    }
                } else {

                    nms = (net.minecraft.server.v1_16_R1.Entity) c.getConstructor(Location.class, com.permadeathcore.Main.getInstance().getNmsHandler().getNMSClass("EntityTypes")).newInstance(location, Main.getInstance().getNmsHandler().convertBukkitToNMS(type));
                }
            }
    ...
    @Override
    public org.bukkit.entity.Entity spawnCustomCreeper(Location location, CreatureSpawnEvent.SpawnReason reason, boolean ender) {

        net.minecraft.server.v1_16_R1.World nmsW = ((org.bukkit.craftbukkit.v1_16_R1.CraftWorld) location.getWorld()).getHandle();
        CustomCreeper nmsEntity = new CustomCreeper(net.minecraft.server.v1_16_R1.EntityTypes.CREEPER, nmsW, ender);
    ...
    public org.bukkit.entity.Entity spawnCustomGhast(Location location, CreatureSpawnEvent.SpawnReason reason, boolean isEnder) {
        ...
        net.minecraft.server.v1_16_R1.World nmsW = ((org.bukkit.craftbukkit.v1_16_R1.CraftWorld) location.getWorld()).getHandle();
        CustomGhast nmsEntity = new CustomGhast(net.minecraft.server.v1_16_R1.EntityTypes.GHAST, nmsW);
        ...
        if (isEnder) {
            ...
            nmsEntity.getAttributeInstance(net.minecraft.server.v1_16_R1.GenericAttributes.MAX_HEALTH).setValue(200.0D);
    ...
    @Override
    public net.minecraft.server.v1_16_R1.World craftWorld(org.bukkit.World world) {
