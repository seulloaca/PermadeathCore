...
public class NMSHandler_1_16_R2 implements NMSHandler {
    ...
    public Entity spawnNMSWither(Location location) {
        ...
        EntityWither wither = EntityTypes.WITHER.spawnCreature((WorldServer) nmsW, compound, null, null,
    ...
    @Override
    public Entity spawnHostileMob(EntityType type, Location location, CreatureSpawnEvent.SpawnReason reason) {
    ...
    @Override
    public Entity spawnCustomCreeper(Location location, CreatureSpawnEvent.SpawnReason reason, boolean ender) {
